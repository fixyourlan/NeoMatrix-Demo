...
#define PIN D6  // Parameter 5 = pin number (most are valid)
...
void display_all_one_color(int color)
{
    matrix->clear();
...
void display_scrollText() {
  ...
  matrix->setTextColor(LED_ORANGE_MEDIUM);  matrix->print("H");
  matrix->setTextColor(LED_RED_MEDIUM);  matrix->print("e");
  matrix->setTextColor(LED_BLUE_MEDIUM);  matrix->print("l"); 
  matrix->setTextColor(LED_GREEN_MEDIUM);  matrix->print("l"); 
  matrix->setTextColor(LED_CYAN_MEDIUM);  matrix->print("o");
  matrix->setTextColor(LED_RED_HIGH);  matrix->print(" J");
  matrix->setTextColor(LED_GREEN_HIGH);  matrix->print("i");
  matrix->setTextColor(LED_BLUE_HIGH);  matrix->print("m");  
...
void loop() {
    ...
    display_scrollText();
    display_all_one_color(LED_WHITE_HIGH);
    display_all_one_color(LED_WHITE_MEDIUM);
    display_all_one_color(LED_WHITE_LOW);
    display_all_one_color(LED_RED_HIGH);
    display_all_one_color(LED_RED_MEDIUM);
    display_all_one_color(LED_RED_LOW);
    display_all_one_color(LED_BLUE_HIGH);
    display_all_one_color(LED_BLUE_MEDIUM);
    display_all_one_color(LED_BLUE_LOW);
    display_all_one_color(LED_GREEN_HIGH);
    display_all_one_color(LED_GREEN_MEDIUM);
    display_all_one_color(LED_GREEN_LOW);
    display_all_one_color(LED_ORANGE_HIGH);
    display_all_one_color(LED_ORANGE_MEDIUM);
    display_all_one_color(LED_ORANGE_LOW);
    display_all_one_color(LED_CYAN_HIGH);
    display_all_one_color(LED_CYAN_MEDIUM);
    display_all_one_color(LED_CYAN_LOW);
